CREATE TABLE IF NOT EXISTS Fox (id BIGINT NOT NULL PRIMARY KEY, name VARCHAR(255) NOT NULL, species VARCHAR(255) NOT NULL, gender VARCHAR(10) NOT NULL, image CLOB);
